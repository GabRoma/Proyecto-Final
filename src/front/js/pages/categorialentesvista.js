...
export const VistaCatLentes = (props) => {
  ...
  return (
    <>
      <p className="fst-italic fw-bold fs-1 text-center ">Lentes</p>
      <hr />
      <small className=" fs-5 mx-3 ">
        Lentes. En TiendaNuestra.com encuentras los mejores celulares al mejor
      ...
      <div className="row row-cols-1 row-cols-md-3 g-4">
        <div className="col">
          <div className="card mx-5 " style={{ width: 250 }}>
            <Link to={"/singlelentes/" + props.theid} className=" ">
              <img
        ...
        >
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingTwo">
              ...
              >
                ¿Qué marcas puedo encontrar en Lentes en TiendaNuestra?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body lh-1">
                ...
                Lentes, tales como: <ul className="my-1">● </ul>{" "}
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
              ...
              >
                ¿Cómo comprar Lentes en TiendaNuestra desde Uruguay?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                Comprar Lentes en TiendaNuestra es muy fácil! Solo debes seguir
                4 simples pasos:
                <ul className="my-1">
                  1- Selecciona la oferta de Lentes que deseas comprar.
                </ul>
                <ul className="my-1">
