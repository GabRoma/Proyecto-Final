...
export const VistaCatCamaras = (props) => {
  ...
  return (
    <>
      <p className="fst-italic fw-bold fs-1 text-center ">Cámaras Digitales </p>
      <hr />
      <small className=" fs-5 mx-3 ">
        Cámaras Digitales. En TiendaNuestra.com encuentras los mejores celulares
        al mejor precio, directo desde USA hasta la puerta de tu casa.
      </small>
      <hr />
      <div className="row row-cols-1 row-cols-md-3 g-4">
        <div className="col">
          <div className="card mx-5 " style={{ width: 250 }}>
            <Link to={"/singlecamaras/" + props.theid} className=" ">
              <img
      ...
      <p className="fs-4 text-center text-secondary">
        Más información sobre Cámaras Digitales
      </p>
        ...
        >
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingTwo">
              ...
              >
                ¿Qué marcas puedo encontrar en Cámaras Digitales en
                TiendaNuestra?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body lh-1">
                ...
                Cámaras Digitales, tales como: <ul className="my-1">● Canon</ul>{" "}
                <ul className="my-1">● KODAK</ul>{" "}
                <ul className="my-1">● Nikon</ul>
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
              ...
              >
                ¿Cómo comprar Cámaras Digitales en TiendaNuestra desde Uruguay?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                Comprar Cámaras Digitales en TiendaNuestra es muy fácil! Solo
                debes seguir 4 simples pasos:
                <ul className="my-1">
                  1- Selecciona la oferta de Cámaras Digitales que deseas
                  comprar.
                </ul>
                <ul className="my-1">
