...
export const VistaCatCelulares = (props) => {
  ...
  return (
    <>
      <p className="fst-italic fw-bold fs-1 text-center ">Celulares</p>
      <hr />
      <small className=" fs-5 mx-3 ">
        Celulares. En TiendaNuestra.com encuentras los mejores celulares al
      ...
      <div className="row row-cols-1 row-cols-md-3 g-4">
        <div className="col">
          <div className="card mx-5 " style={{ width: 250 }}>
            <Link to={"/singlecelulares/" + props.theid} className=" ">
              <img
        ...
        >
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingTwo">
              ...
              >
                ¿Qué marcas puedo encontrar en Celulares en TiendaNuestra?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                ...
                Celulares , tales como: <ul className="my-1">● Apple</ul>{" "}
                <ul className="my-1">● Samsung</ul>{" "}
                <ul className="my-1">● Huawei</ul>{" "}
                <ul className="my-1">● LG</ul>
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
              ...
              >
                ¿Cómo comprar Celulares en TiendaNuestra desde Uruguay?
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                Comprar Celulares en TiendaNuestra es muy fácil! Solo debes
                seguir 4 simples pasos:
                <ul className="my-1">
                  1- Selecciona la oferta de Celulares que deseas comprar.
                </ul>
                <ul className="my-1">
