...
export const Checkout = (props) => {
    ...
    return ( <
        ...
        <
        i className = "fa fa-user-circle my-2"
        style = {
            {
                fontSize: "xx-large"
            }
        ...
        PayPalScriptProvider options = {
            {
                "client-id": "AWPAObhvjPw_04n3sa25OckhtwDPdpB0LZBmVTz5e7tFD6gNJVLcCPz-je-FXk7gqlMfJ3v6plevoM-T",
            }
        } >
        <
